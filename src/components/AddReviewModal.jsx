...
const AddReviewModal = ({ userId, productId }) => {
  ...
  const formik = useFormik({
    ...
    onSubmit: async (values) => {
      try {
        const data = { ...values, rating: parseInt(values.rating) };
              ...
              <form onSubmit={formik.handleSubmit}>
                <div className="w-full flex flex-col px-5">
                  <div className="flex">
                    ...
                    <div className="w-[30%] flex items-center justify-end rating sm:pr-2">
                      <input
                        type="radio"
                        id="rating"
                        name="rating"
                  ...
                  <div className="w-[70%] flex flex-col relative">
                    ...
                    <div className="w-full flex justify-between">
                      ...
                      <div className="flex items-center gap-2 pt-2 pb-3">
                        <input
                          id="is_anonymus"
                          value={formik.values.is_anonymus}
                          onChange={formik.handleChange}
                          onBlur={formik.handleBlur}
                          type="checkbox"
